...
var arEventi = [   
   ...
   { nome: 'Castorano Experiences - Borgo Aperto', data: '28/07/2024', luogo: 'Castorano (AP)', link: '', indirizzo: 'Piazza Giacomo Leopardi, Castorano (AP)', indirizzoLink: 'https://maps.app.goo.gl/6BDVsgiJckWHyzfMA' },
