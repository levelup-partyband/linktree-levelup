...
export const eventi2026: Event[] = [
  ...
  { nome: 'Crazy Summer Chalet – ore 17:00', data: '12/07/2026', luogo: "Via Faleria, 110 – Porto Sant'Elpidio (FM)", indirizzo: "Via Faleria, 110, 63821 Porto Sant'Elpidio FM", indirizzoLink: 'https://maps.app.goo.gl/zAigAGm7kzYQJCSU8', link: 'https://www.instagram.com/crazysummerchalet/' },
  { nome: 'Milè Bar', data: '08/08/2026', luogo: 'Lungomare Europa, 34 – Martinsicuro (TE)', link: 'https://www.instagram.com/mile.moltopiudiunbar', indirizzo: 'Lungomare Europa, 34, 64014 Martinsicuro TE', indirizzoLink: 'https://maps.google.com/?q=Lungomare+Europa+34,+Martinsicuro+TE' },
  { nome: 'Tutti Malti per Colonnella', data: '13/08/2026', luogo: 'Piazza del Popolo - Colonnella (TE)', indirizzo: 'Piazza del Popolo, 64010 Colonnella TE', indirizzoLink: 'https://maps.google.com/?q=Piazza+del+Popolo,+64010+Colonnella+TE', link: 'https://www.instagram.com/tutti_malti_per_colonnella/' },
...
export const eventi2025: Event[] = [
  ...
  { nome: 'Festa Privata - Matrimonio', data: '14/06/2025', luogo: 'Marina Palmense (FM)' },
  ...
  { nome: '24° Sagra dei Maccheroncini alla Pagliarana', data: '31/07/2025', luogo: 'Pagliare del Tronto (AP)', link: 'https://www.facebook.com/events/687396143877688/', indirizzo: 'Piazza Kennedy, 63078 Pagliare del Tronto AP', indirizzoLink: 'https://maps.app.goo.gl/hrujjeCpyioHprJF6' },
  ...
  { nome: 'Chalet Mimosa 45', data: '06/08/2025', luogo: 'Grottammare (AP)', indirizzo: 'Lungomare della Repubblica, 45, 63066 Grottammare AP', indirizzoLink: 'https://maps.app.goo.gl/rA84smajfJGYoykT6' },
  { nome: 'Festa Privata - Compleanno', data: '09/08/2025', luogo: 'Spinetoli (AP)' },
  ...
  { nome: 'Memorial', data: '30/08/2025', luogo: "Villa Marchesa, Sant'Edigio (TE)", link: 'https://www.facebook.com/events/2881021962101341/' },
  { nome: 'Festa Privata - Matrimonio', data: '27/09/2025', luogo: 'Villa Nicolai - Monteprandone (AP)' },
  { nome: 'Capodanno 2026', data: '31/12/2025', luogo: 'Hotel Ristorante - Le Tre Lanterne (AP)' },
];

export const eventi2024: Event[] = [
  ...
  { nome: 'Festa Privata - Matrimonio', data: '21/09/2024', luogo: 'Villa Nicolai - Monteprandone (AP)' },
