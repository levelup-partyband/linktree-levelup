...
export const eventi2026: Event[] = [
  ...
  { nome: 'Chalet Casablanca', data: '24/08/2026', luogo: "Porto d'Ascoli (AP)", indirizzo: 'Viale Rinascimento, 8, 63074 San Benedetto del Tronto AP', indirizzoLink: 'https://maps.app.goo.gl/iHpkKCW4qGqk4Uxp6' },
  { nome: 'Déjavu', data: '10/09/2026', luogo: "Sant'Egidio alla Vibrata (TE)" },
